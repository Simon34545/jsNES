...
var pt0 = document.getElementById('pt0').getContext('2d');
var pt1 = document.getElementById('pt1').getContext('2d');
...
// useful things i found in fceux debugger

function runLine(noDraw) {
	var cur_scanline = Number(nes.ppu.scanline);
	
	while (cur_scanline == nes.ppu.scanline) {
		handleCycles(noDraw);
	}
}
