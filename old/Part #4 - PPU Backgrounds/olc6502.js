class olc6502 {
	...
	//constructor() {
		...
		clock() {
			// prevent overflows
			window.nes.cpu.pc &=   0xFFFF;
			window.nes.cpu.a &=    0x00FF;
			window.nes.cpu.stkp &= 0xFFFF;
			window.nes.cpu.x &=    0x00FF;
			window.nes.cpu.y &=    0x00FF;
			...
			if (window.nes.cpu.cycles == 0) {
				...
				var dataLength = Math.min(4, window.nes.cpu.pc - oldPC);
				...
				dataString = dataLength ? ((dataLength ? '$' : '') + dataValue.toString(16).padStart(dataLength * 2, '0').toUpperCase()).padStart(4, '#').substring(0,5) : '';
		...
		ZP0() {
			...
			window.nes.cpu.pc = (window.nes.cpu.pc + 1) & 0xFFFF;
			window.nes.cpu.addr_abs &= 0x00FF;
			return 0;
		}
		
		ZPX() {
			window.nes.cpu.addr_abs = window.nes.cpu.read((window.nes.cpu.pc + window.nes.cpu.x) & 0xFFFF);
			window.nes.cpu.pc = (window.nes.cpu.pc + 1) & 0xFFFF;
			window.nes.cpu.addr_abs &= 0x00FF;
			return 0;
		}
		...
		ZPY() {
			window.nes.cpu.addr_abs = window.nes.cpu.read((window.nes.cpu.pc + window.nes.cpu.y) & 0xFFFF);
			window.nes.cpu.pc = (window.nes.cpu.pc + 1) & 0xFFFF;
			window.nes.cpu.addr_abs &= 0x00FF;
			return 0;
		}
		...
		ABS() {
			...
			window.nes.cpu.addr_abs = ((hi << 8) & 0xFFFF) | lo;
		...
		ABX() {
			...
			window.nes.cpu.addr_abs = ((hi << 8) & 0xFFFF) | lo;
			window.nes.cpu.addr_abs = (window.nes.cpu.addr_abs + window.nes.cpu.x) & 0xFFFF;
			
			if ((window.nes.cpu.addr_abs & 0xFF00) != ((hi << 8) & 0xFFFF)) {
				return 1;
			} else {
				return 0;
			}
		...
		IND() {
			...
			var ptr = ((ptr_hi << 8) & 0xFFFF) | ptr_lo;
			
			if (ptr_lo == 0x00FF) { // Simulate page boundary hardware bug
				window.nes.cpu.addr_abs = ((window.nes.cpu.read(ptr & 0xFF00) << 8) | window.nes.cpu.read(ptr + 0)) & 0xFFFF;
			} else { //Behave normally
				window.nes.cpu.addr_abs = ((window.nes.cpu.read(ptr + 1) << 8) | window.nes.cpu.read(ptr + 0)) & 0xFFFF;
			}
		...
		IZY() {
			...
			window.nes.cpu.addr_abs = ((hi << 8) & 0xFFFF) | lo;
			window.nes.cpu.addr_abs = (window.nes.cpu.addr_abs + window.nes.cpu.y) & 0xFFFF;
		...
		BCS() {
			if (window.nes.cpu.GetFlag(window.nes.cpu.FLAGS6502.C) == 1) {
				window.nes.cpu.cycles++;
				window.nes.cpu.addr_abs = (window.nes.cpu.pc + window.nes.cpu.addr_rel) & 0xFFFF;
		...
		SBC() {
			...
			var value = ((window.nes.cpu.fetched) ^ 0x00FF) & 0xFFFF;
		...
		PHA() {
			window.nes.cpu.write((0x0100 + window.nes.cpu.stkp) & 0xFFFF, window.nes.cpu.a);
			window.nes.cpu.stkp = (window.nes.cpu.stkp - 1) & 0xFFFF;
			return 0;
		}
		
		PLA() {
			window.nes.cpu.stkp = (window.nes.cpu.stkp + 1) & 0xFFFF;
			window.nes.cpu.a = window.nes.cpu.read((0x0100 + window.nes.cpu.stkp) & 0xFFFF);
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.Z, window.nes.cpu.a == 0x00);
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.N, window.nes.cpu.a & 0x80);
			return 0;
		}
		...
		irq() {
			if (window.nes.cpu.GetFlag(window.nes.cpu.FLAGS6502.I) == 0) {
				window.nes.cpu.write((0x0100 + window.nes.cpu.stkp) & 0xFFFF, (window.nes.cpu.pc >> 8) & 0x00FF);
				window.nes.cpu.stkp = (window.nes.cpu.stkp - 1) & 0xFFFF;
				window.nes.cpu.write((0x0100 + window.nes.cpu.stkp) & 0xFFFF, window.nes.cpu.pc & 0x00FF);
				window.nes.cpu.stkp = (window.nes.cpu.stkp - 1) & 0xFFFF;
				...
				window.nes.cpu.write((0x0100 + window.nes.cpu.stkp) & 0xFFFF, window.nes.cpu.status);
				window.nes.cpu.stkp = (window.nes.cpu.stkp - 1) & 0xFFFF;
				
				window.nes.cpu.addr_abs = 0xFFFE;
				var lo = window.nes.cpu.read(window.nes.cpu.addr_abs + 0);
				var hi = window.nes.cpu.read(window.nes.cpu.addr_abs + 1);
				window.nes.cpu.pc = ((hi << 8) & 0xFFFF) | lo;
		...
		RTI() {
			window.nes.cpu.stkp = (window.nes.cpu.stkp + 1) & 0xFFFF;
			window.nes.cpu.status = window.nes.cpu.read((0x0100 + window.nes.cpu.stkp) & 0xFFFF);
			window.nes.cpu.status &= ~window.nes.cpu.FLAGS6502.B;
			window.nes.cpu.status &= ~window.nes.cpu.FLAGS6502.U;
			
			window.nes.cpu.stkp = (window.nes.cpu.stkp + 1) & 0xFFFF;
			window.nes.cpu.pc = window.nes.cpu.read((0x0100 + window.nes.cpu.stkp) & 0xFFFF);
			window.nes.cpu.stkp = (window.nes.cpu.stkp + 1) & 0xFFFF;
			window.nes.cpu.pc |= (window.nes.cpu.read((0x0100 + window.nes.cpu.stkp) & 0xFFFF) << 8) & 0xFFFF;
			return 0;
		}
		
		ASL() {
			window.nes.cpu.fetch();
			var temp = (window.nes.cpu.fetched << 1) & 0xFFFF;
		...
		CMP() {
			window.nes.cpu.fetch();
			var temp = (window.nes.cpu.a - window.nes.cpu.fetched & 0xFFFF) & 0xFFFF;
		...
		CPX() {
			window.nes.cpu.fetch();
			var temp = (window.nes.cpu.x - window.nes.cpu.fetched & 0xFFFF) & 0xFFFF;
		...
		CPY() {
			window.nes.cpu.fetch();
			var temp = (window.nes.cpu.y - window.nes.cpu.fetched & 0xFFFF) & 0xFFFF;
		...
		DEX() {
			window.nes.cpu.x = (window.nes.cpu.x - 1) & 0xFF;
		...
		DEY() {
			window.nes.cpu.y = (window.nes.cpu.y - 1) & 0xFF;
		...
		PHP() {
			window.nes.cpu.write((0x0100 + window.nes.cpu.stkp) & 0xFFFF, window.nes.cpu.status | window.nes.cpu.FLAGS6502.B | window.nes.cpu.FLAGS6502.U);
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.B, 0);
		...
		ROL() {
			window.nes.cpu.fetch();
			var temp = ((window.nes.cpu.fetched << 1) & 0xFFFF) | window.nes.cpu.GetFlag(window.nes.cpu.FLAGS6502.C);
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.C, temp & 0xFF00);
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.Z, (temp & 0x00FF) == 0x0000);
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.N, temp & 0x0080);
			if (window.nes.cpu.lookup[window.nes.cpu.opcode][2] == window.nes.cpu.IMP) {
		...
		ROR() {
			window.nes.cpu.fetch();
			var temp = ((window.nes.cpu.GetFlag(window.nes.cpu.FLAGS6502.C) << 7) & 0xFFFF) | (window.nes.cpu.fetched >> 1);
		...
		TSX() {
			window.nes.cpu.x = (window.nes.cpu.stkp) & 0xFF;
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.Z, window.nes.cpu.x == 0x00);
			window.nes.cpu.SetFlag(window.nes.cpu.FLAGS6502.N, window.nes.cpu.x & 0x80);
			return 0;
		}
